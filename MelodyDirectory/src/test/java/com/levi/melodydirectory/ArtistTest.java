...
class ArtistTest {
	...
	@Test
	void testToString() {
		Song SF = new Song("Sunflower", "From SpiderMan, Into The Spiderverse", "Pop", "10/18/18", "N/A", 7, 0, "SpiderMan Soundtrack", "$2.00", "2:00");
		ArrayList<Song> songs = new ArrayList<>();
		songs.add(SF);
		Album spiderMan = new Album("SpiderMan Into the SpiderVerse", "Movie Soundtrack", "Pop", "10/18/18", "N/A",  7, 0, "Various Artists", songs, "Marvel Studios", "$2.00");
		ArrayList<Album> albums = new ArrayList<>();
		albums.add(spiderMan);
		Artist marvel = new Artist("Marvel", "Soundtrack for SpiderMan ITSV", "Pop", "10/18/18", "Marvel.com",  7, 0, albums);
	...
	void testGetAlbums() {
		Song SF = new Song("Sunflower", "From SpiderMan, Into The Spiderverse", "Pop", "10/18/18", "N/A", 7, 0, "SpiderMan Soundtrack", "$2.00", "2:00");
		Song SF2 = new Song("Sunflower", "From SpiderMan, ITSV", "Pop", "10/18/18", "N/A", 7, 0, "SpiderMan Soundtrack", "$2.00", "2:00");
		ArrayList<Song> songs = new ArrayList<>();
		ArrayList<Song> songs2 = new ArrayList<>();
		songs.add(SF);
		songs2.add(SF2);
		Album spiderMan = new Album("SpiderMan ITSV", "Movie Soundtrack", "Pop", "10/18/18", "N/A",  7, 0, "Various Artists", songs, "Marvel Studios", "$2.00");
		ArrayList<Album> albums = new ArrayList<>();
